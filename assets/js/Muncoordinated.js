...
var _user$project$Actor$Actor = F3(
	function (a, b, c) {
		return {name: a, tier: b, checked: c};
	});
var _user$project$Actor$NGO = {ctor: 'NGO'};
var _user$project$Actor$Observer = {ctor: 'Observer'};
var _user$project$Actor$Delegate = {ctor: 'Delegate'};
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				...
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					(_elm_lang$core$Native_Utils.cmp(value, 1) > 0) ? _elm_lang$core$Native_Utils.update(
						model,
						{
							timeField: _elm_lang$core$Basics$toString(value - 1)
						}) : model,
...
var _user$project$Timer$SetCountWithField = {ctor: 'SetCountWithField'};
var _user$project$Timer$SetCount = function (a) {
	return {ctor: 'SetCount', _0: a};
};
var _user$project$Timer$UpdateUnitDropdown = function (a) {
	return {ctor: 'UpdateUnitDropdown', _0: a};
};
...
var _user$project$SpeakersList$UpdateUnitDropdown = function (a) {
	return {ctor: 'UpdateUnitDropdown', _0: a};
};
...
var _user$project$ListManager$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'AddList':
				if (!_elm_lang$core$Native_Utils.eq(model.nameField, '')) {
					var response = _user$project$SpeakersList$init;
					return A2(
						_elm_lang$core$Platform_Cmd_ops['!'],
						_elm_lang$core$Native_Utils.update(
...
var _user$project$ModeratedCaucus$Model = F4(
	function (a, b, c, d) {
		return {topicField: a, textSize: b, caucusTimer: c, speakerTimer: d};
	});
var _user$project$ModeratedCaucus$SpeakerTimer = function (a) {
	return {ctor: 'SpeakerTimer', _0: a};
};
var _user$project$ModeratedCaucus$CaucusTimer = function (a) {
...
var _user$project$ModeratedCaucus$ClearTopicField = {ctor: 'ClearTopicField'};
	...
	var countTier = function (tier) {
		return _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
				function (x) {
					return _elm_lang$core$Native_Utils.eq(x.tier, tier);
				},
				actors));
	};
	var totalDelegates = (countTier(_user$project$Actor$Delegate) + countTier(_user$project$Actor$NGO)) + countTier(_user$project$Actor$Observer);
	var quorum = _elm_lang$core$Basics$ceiling(
		_elm_lang$core$Basics$toFloat(totalDelegates) * 0.5);
	var votingDelegates = countTier(_user$project$Actor$Delegate);
	var draftResolution = _elm_lang$core$Basics$ceiling(
		_elm_lang$core$Basics$toFloat(votingDelegates) * 0.25);
	var amendment = _elm_lang$core$Basics$ceiling(
...
var _user$project$Main$SpeakersTab = function (a) {
	return {ctor: 'SpeakersTab', _0: a};
};
var _user$project$Main$ModCaucusTab = function (a) {
...
var _user$project$Main$init = function () {
	...
	var actors$ = A2(
		...
		A2(_elm_lang$core$List$map, _user$project$Actor$Actor, names));
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		{
		...
		switch (_p0.ctor) {
			...
			case 'AddActor':
				var actor = {
					name: A2(
						_elm_lang$core$Basics_ops['++'],
						'🇦🇶',
						A2(_elm_lang$core$Basics_ops['++'], ' ', model.actorField)),
					tier: _user$project$Actor$Default,
					checked: false
				};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'Downgrade':
				var downgradeActor = function (a) {
					return _elm_lang$core$Native_Utils.eq(a.name, _p0._0.name) ? _elm_lang$core$Native_Utils.update(
						a,
						{tier: _user$project$Actor$Default}) : a;
				};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
			...
			case 'ClearCommittee':
				var resetActor = function (a) {
					return _elm_lang$core$Native_Utils.update(
						a,
						{tier: _user$project$Actor$Default, checked: false});
				};
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
...
var _user$project$Main$viewActorsOfTier = F2(
...
var _user$project$Main$AddActor = {ctor: 'AddActor'};
var _user$project$Main$UpdateActorNameField = function (a) {
	return {ctor: 'UpdateActorNameField', _0: a};
};
...
var _user$project$Main$viewCommittee = function (model) {
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('committeeTab')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
